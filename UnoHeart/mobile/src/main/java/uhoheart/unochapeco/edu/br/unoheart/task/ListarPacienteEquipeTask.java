...
public class ListarPacienteEquipeTask extends AsyncTask<PacienteEquipe, Void, List<PacienteEquipe>> {

    private ExceptionTask exceptionTask;
    private Context context;
    private ListenerRetornoPacienteEquipe retorno;

    public ListarPacienteEquipeTask(Context context, ListenerRetornoPacienteEquipe retorno) {
        this.context = context;
        this.retorno = retorno;
    }

    @Override
    protected List<PacienteEquipe> doInBackground(PacienteEquipe... pacienteEquipes) {
        try {
            URL url = RotinasSistemaListagem.SELECIONAR_PACIENTE_EQUIPE.getUrl();
            ...
            if (con.getResponseCode() == 200) {
                ...
                TypeToken<List<PacienteEquipe>> tpToken = new TypeToken<List<PacienteEquipe>>() {

                };

                List<PacienteEquipe> itens = g.fromJson(reader, tpToken.getType());
    ...
    @Override
    protected void onPostExecute(List<PacienteEquipe> itens) {
